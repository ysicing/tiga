      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          <CardHeader>
            ...
            <CardDescription>
              Real-time status of all managed instances
            </CardDescription>
          </CardHeader>
              ...
              {[
                {
                  ...
                  target: 'mysql-prod-03',
                  user: 'admin',
                  time: '2m ago',
                },
                {
                  action: 'Alert Resolved',
                  target: 'redis-cache-01',
                  user: 'system',
                  time: '15m ago',
                },
                {
