...
import { AlertCircle, Database, Loader2, Settings, User } from 'lucide-react'
    ...
    try {
      ...
      setError(
        err instanceof Error
          ? err.message
          : t('install.confirm.installationError')
      )
    } finally {
  ...
  if (!state.database || !state.admin || !state.settings) {
    return (
      <Alert variant="destructive">
        ...
        <AlertDescription>
          {t('install.confirm.incompleteData')}
        </AlertDescription>
      </Alert>
    )
  }
