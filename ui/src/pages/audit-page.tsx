    ...
    <div className="space-y-6">
      ...
      <div className="mb-4">
        <div className="flex items-center gap-3 mb-2">
          <h1 className="text-3xl">{t('audit.title', '审计日志')}</h1>
        </div>
        <p className="text-muted-foreground">
          {t('audit.description', '查看和分析系统操作审计日志')}
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">
              {t('audit.current_page_events', 'Current Page')}
            </CardTitle>
          ...
          <div className="grid gap-4 md:grid-cols-5">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFilters({ ...filters, subsystem: value === 'all' ? '' : value })
                }
              >
                <SelectTrigger>
                  <SelectValue
                ...
                <TableRow key={event.id}>
                  ...
                  <TableCell className="text-xs">
                    <div className="flex items-center gap-1">
                      ...
                      {event.user.username || event.user.uid || 'System'}
                    </div>
                  </TableCell>
                  <TableCell>
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-4 grid-cols-2">
              ...
              <div>
                ...
                <div className="text-sm">{event.resource.type}</div>
              </div>
              <div>
                <Label className="text-xs text-muted-foreground">
              ...
              <div>
                ...
                <div className="text-sm">{event.user.username || event.user.uid}</div>
              </div>
              {event.client_ip && (
                <div>
                  <Label className="text-xs text-muted-foreground">
              ...
              {event.request_method && (
                <div>
                  <Label className="text-xs text-muted-foreground">
                    {t('audit.request_method', 'Request Method')}
                  </Label>
                  <div className="text-sm">{event.request_method}</div>
                </div>
              )}
            </div>
