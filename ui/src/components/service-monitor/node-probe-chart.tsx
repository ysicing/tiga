        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          {data.map((service, index) => {
            const avgDelay = service.avg_delays.length > 0
              ...
              : 0;
            const avgUptime = service.uptimes.length > 0
              ? service.uptimes.reduce((a, b) => a + b, 0) / service.uptimes.length
              : 0;
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-medium truncate">{service.service_monitor_name}</p>
